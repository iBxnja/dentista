...
<input type="hidden" name="id" value="{{ isset($notas) ? $notas->idNota : '0' }}">
    <h2 class="text-4xl">Nueva nota</h2>
    <div class="w-11/12 h-full flex items-center justify-center flex-col mt-10">
        <div class="w-full h-full flex flex-col items-center justify-around">
            <div class="flex flex-col justify-center items-center w-5/12 mt-7 cel:w-full">
                ...
                <input type="text" name="txtNumeroSesion" id="txtNumeroSesion" class="w-full h-8 rounded-lg border-2 border-black text-center" placeholder="Escribe el numero de la sesión">
            </div>
            ...
            <div class="flex flex-col justify-center items-center w-5/12 mt-7 cel:w-full">
                ...
                <input type="text" name="txtTitulo" id="txtTitulo" class="w-full h-8 rounded-lg border-2 border-black text-center" placeholder="Escribe el titulo de la nota">
            </div>
            <div class="flex flex-col justify-center items-center w-5/12 mt-7 cel:w-full">
