...
<section class="w-full h-full flex items-center justify-center flex-col">
  ...
  <form action="" class="w-full h-full flex items-center flex-col justify-center">
    <div class="w-11/12 h-20 bg-teal-400 flex items-center justify-start">
      <input type="text" name="buscarpor" id="buscarpor" class=" text-center w-1/4 h-10 ml-5 rounded-lg border-2 border-black" placeholder="Buscar una nota..." value="">
      <button type="submit" class="w-40 h-10 bg-green-500 text-white ml-5 rounded-lg">Buscar</button>
    </div>
    
    
    
    <div class="w-11/12 h-full flex items-center justify-between mt-3 flex-wrap">
      <!--foreach-->
      @foreach ($aNota as $nota)
          <div class="w-80 h-96 bg-teal-200 my-5 relative flex items-center justify-center flex-col border-4 border-teal-500 text-center overflow-hidden">
