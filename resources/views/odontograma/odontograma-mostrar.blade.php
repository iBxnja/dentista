...
@endphp --}}
    <section clasS="w-full h-full flex-col flex items-center justify-center">
        <h2 class="my-5">Odontograma digital</h2>
        ...
        <div class="w-11/12 h-full bg-teal-300 shadow-md shadow-neutral-500 flex items-center justify-center my-5 py-10">
            <div class="w-1/4 h-96 flex items-center justify-center flex-col">
              ...
              <div class="w-full h-full  flex items-center justify-center flex-col">
                ...
                <div class="w-full flex items-center justify-center mb-4 mt-4">
                  ...
                  <span class="w-2/4 border-b-2 border-black bg-transparent text-center" style="color: black;">{{ $odontograma->cariado }}</span>
                </div>
                
                <div class="w-full flex items-center justify-center mt-4 mb-4">
                  <label for="obturado" class="w-2/4 text-center">Obturados</label>
                  <span type="text" name="obturado" class="w-2/4 border-b-2 border-black bg-transparent text-center" style="color: black;">{{ $odontograma->obturado }}</span>
                </div>
                
                <div class="w-full flex items-center justify-center mt-4 mb-4">
                  <label for="perdida" class="w-2/4 text-center">Perdida por caries</label>
                  <span type="text" name="perdida" class="w-2/4 border-b-2 border-black bg-transparent text-center" style="color: black;">{{ $odontograma->perdida }}</span>
                </div>
        
                <div class="w-full flex items-center justify-center mt-4 mb-4">
                  <label for="extraccion" class="w-2/4 text-center">Extracciones</label>
                  <span type="text" name="extraccion" class="w-2/4 border-b-2 border-black bg-transparent text-center" style="color: #6b7280;">{{ $odontograma->extraccion }}</span>
                </div>
        
                <div class="w-full flex items-center justify-center mt-4 mb-4">
                  <label for="sano" class="w-2/4 text-center">Sanos</label>
                  <span type="text" name="sano" class="w-2/4 border-b-2 border-black bg-transparent text-center" style="color: black;">{{ $odontograma->sano }}</span>
                </div>
            ...
            <div class="ml-5 w-8/12 h-full flex items-start justify-center flex-col">
              <div class="shadow-neutral-400 bg-white shadow-md resize-none h-96 w-full overflow-x-hidden">{{ $odontograma->observacion }}</div>
            </div>
