...
@section('contenido')
    <section class="w-full h-full flex items-center justify-center flex-wrap text-white">
        ...
        <div class="shadow-md shadow-neutral-500 border-4 border-violet-500 mt-5 mx-10 w-80 h-40 bg-violet-400 rounded-xl flex items-center justify-center flex-col overflow-hidden">
