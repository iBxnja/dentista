...
@section('contenido')
    <section class="w-full h-full flex items-center justify-center flex-col">
        <div class="w-full cel:h-full flex items-center justify-center">
            <div class="w-11/12 h-full flex items-center cel:justify-around">
                <a href="/inicio/cliente-nuevo">
                    ...
                    xl:my-4 xl:w-40 xl:rounded-3xl xl:h-14 xl:text-lg">Nuevo cliente</button>
                </a>
        ...
        <div class="flex items-center justify-center w-10/12 my-5 h-24 bg-gradient-to-tr from-teal-300 via-teal-400 to-teal-300">
            ...
            <div class="w-4/12 h-16 flex items-center justify-around">
                <a href="{{ isset($clientes->idCliente) ? route('cliente.eliminar', ['id' => $clientes->idCliente]) : '' }}" class="w-12 h-12 xl:hover:w-14 xl:hover:h-14 ease-in-out duration-100 xl:hover:bg-red-500 xl:hover:text-white rounded-full bg-white grid place-items-center cel:text-base text-3xl" name="btnEliminarCliente">
