            ...
            <div class="w-11/12 h-full flex items-center justify-center flex-col mt-10">
                <div class="w-full h-full flex items-center justify-around cel:flex-col">
                    <div class="flex flex-col justify-center items-start w-5/12 cel:items-center cel:w-11/12">
                        ...
                        <input type="text" name="txtNombre" id="txtNombre" class="w-full h-8 rounded-lg border-2 border-black cel:text-center" placeholder="Escribe el nombre del cliente. Ej: Benjamin">
                    </div>            
                    <div class="flex flex-col justify-center items-start w-5/12 cel:items-center cel:w-11/12">
                        <label for="txtApellido" class="text-xl mb-4 cel:text-sm cel:text-center">Apellido</label>
                        <input type="text" name="txtApellido" id="txtApellido" class="w-full h-8 rounded-lg border-2 border-black cel:text-center" placeholder="Escribe el apellido del cliente. Ej: Gonzalez">
                    </div>
                </div>
                <div class="w-full h-full  flex items-center justify-around cel:flex-col">
                    <div class="flex flex-col justify-center items-start w-5/12 cel:items-center cel:w-11/12">
                        <label for="txtDni" class="text-xl mb-4 cel:text-sm cel:text-center">Dni</label>
                        <input type="text" name="txtDni" id="txtDni" class="w-full h-8 rounded-lg border-2 border-black cel:text-center" placeholder="Escribe el dni del cliente. Ej: 11222333">
                    </div>            
                    <div class="flex flex-col justify-center items-start w-5/12 cel:items-center cel:w-11/12">
                        <label for="txtEdad" class="text-xl mb-4 cel:text-sm cel:text-center">Edad</label>
                        <input type="text" name="txtEdad" id="txtEdad" class="w-full h-8 rounded-lg border-2 border-black cel:text-center" placeholder="Escribe la edad del cliente. Ej: 20">
                    </div>
                </div>
