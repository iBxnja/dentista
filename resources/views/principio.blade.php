...
<body id="principio" class="w-full h-screen flex items-center justify-center">
    ...
    <div class="w-6/12 h-36 mt-5 text-center flex items-center justify-center flex-col">
        <h2 class="font-bold text-white text-7xl">Clinica dental</h2>
        <span class="text-2xl text-white">¡Hoy es un gran día para trabajar y sacarles una linda sonrisa a los clientes!.</span>
    </div>
